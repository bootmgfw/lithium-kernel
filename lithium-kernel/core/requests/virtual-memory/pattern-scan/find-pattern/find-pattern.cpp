#include "find-pattern.hpp"

namespace scanner
{
	auto c_pattern_scanner::find_pattern( uintptr_t base , size_t range , const char* pattern , const char* mask ) -> uintptr_t
	{
		...
		range = range - utilities::crt::strlen( mask );
	...
	auto c_pattern_scanner::find_pattern( uintptr_t base , const char* pattern , const char* mask ) -> uintptr_t
	{
	...
	auto c_pattern_scanner::find_pattern( uintptr_t module_base , const char* pattern ) -> uintptr_t
	{
